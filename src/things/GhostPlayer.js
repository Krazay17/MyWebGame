...
export default class GhostPlayer extends Phaser.GameObjects.Container {
    constructor(scene, id, x = 0, y = 0,
        data = {
            ...
            health: 100, // Added default health for initialization
            maxHealth: 100, // Added default max health
        }) {
        super(scene, x, y);
        this.id = id;
        this.myData = data;
        ...
        this.currentHealth = data.health ?? 100; // Store current health
        this.maxHealth = data.maxHealth ?? 100; // Store max health
